...
| `1B 68` / `1B 69` | **ESC h / i** | Text / graphics output mode. DYMO Connect's "Afdrukkwaliteit" = Tekst / Streepjescode en grafisch; **a genuine 550 prints ≈1.8× slower in graphics mode** (same label: 1.94 s vs 3.19 s in the queue, 19 Sep 2026, D46). We accept and ignore both — our line period is the same in either mode | tech ref p.11; LW5XX.GPD; live timing |
